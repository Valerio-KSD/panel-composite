...
function OnLuaButton_modeloF(framePrincipal)
	...
	if modelo == 100 then --F0 [pieza global capaz de generar todas las demas]
		local html_path
		if remoto==1 then
			html_path = "" .. ruta_carpeta .. "" .. carpeta .. "/referencia000.html"
		else
			html_path = "file:" .. ruta .. "\\Paneles\\referencia000.html"
		end
		
		
		local modelo000 = HTML_Dialog(false, html_path, tamX, tamY, "BANDEJA CLIENTES F0")
		
		textoDescriptivo="BANDEJA F0"
		anchura1=100 anchura2=100 anchura3=0 anchura4=0 anchura5=0 anchura6=0 anchura7=0 anchura8=0 anchura9=0 anchura10=0
		alturaPlaca=500	
		pliegueSuperior=30 pliegueDer=30 pliegueIzq=30 pliegueInferior=30
		alaSuperior=45 alaDerecha=45 alaIzquierda=45 alaInferior=45
		...
		modelo000:AddDoubleField("anchura8", anchura8)
		modelo000:AddDoubleField("anchura9", anchura9)
		modelo000:AddDoubleField("anchura10", anchura10)
...
function OnLuaButton_aceptarF(modelo000)
	...
	if modelo==100 then  --PIEZA F0
		...
		anchura8 = modelo000:GetDoubleField("anchura8")
		anchura9 = modelo000:GetDoubleField("anchura9")
		anchura10 = modelo000:GetDoubleField("anchura10")
		...
		--Punto inicial de la pieza
			--[[if dibujoHorizontal==1 then
				origenX= 400
				origenY= -(anchura1+anchura2+anchura3+anchura4+anchura5+anchura6+anchura7+anchura8+anchura9+anchura10+400)
			else
				origenX=-(alturaPlaca+400)
				origenY= 400
			end
			--]]
		...
		--DisplayMessageBox("valor dibujar
		DisplayMessageBox("MODELO F0 CREADO CORRECTAMENTE")
	
	
	elseif modelo==101 then  --PIEZA F1
...
--TRAMO SUPERIOR--
function OnLuaButton_pliegueDobleSup()
	dibujarForma=1
  return true
end
function OnLuaButton_pliegueSimpleSup()
	dibujarForma=2
  return true
end
function OnLuaButton_ningunoSup()
	dibujarForma=3
  return true
end

--TRAMO INFERIOR--
function OnLuaButton_pliegueDobleInf()
	dibujarForma=4
  return true
end
function OnLuaButton_pliegueSimpleInf()
	dibujarForma=5
  return true
end
function OnLuaButton_ningunoInf()
	dibujarForma=6
  return true
end

--TRAMO IZQUIERDA--
function OnLuaButton_pliegueDobleIzq()
	dibujarForma=7
  return true
end
function OnLuaButton_pliegueSimpleIzq()
	dibujarForma=8
  return true
end
function OnLuaButton_ningunoIzq()
	dibujarForma=9
  return true
end

--TRAMO DERECHA--
function OnLuaButton_pliegueDobleDer()
	dibujarForma=10
  return true
end
function OnLuaButton_pliegueSimpleDer()
	dibujarForma=11
  return true
end
function OnLuaButton_ningunoDer()
	dibujarForma=12
  return true
end
