...
modelo=7 --[AH=0 - AH1=1 - AH2=2 - AH3=3 - AH4=4 - AH5=5 - AH6=6 - AH7=7 - AH8=8]
...
function OnLuaButton_aceptarAH(modeloAH)
	...
	elseif  alturaPlaca < 0 then
		...
		dibujarFresado_AH(doc,anchuraPlaca,alturaPlaca,margenPlaca, origenX,origenY,modelo)
		
		Dibujar_CorteAH(doc,anchuraPlaca,alturaPlaca,margenPlaca,origenX,origenY,modelo)
...
--[[  --ESTO ES LA ANTIGUA FUNCION "Dibujar_FresadoAH"
...
function Dibujar_CorteAH(doc,anchuraPlaca,alturaPlaca,margenPlaca,origenX,origenY,modelo)
	...
	--Inicio
	local corte20 = Point2D(origenX+alaIzquierda+anchuraPlaca+anchoLateral2,origenY+alaInferior+pliegueInferior+alturaLateral2)
	local corte21 = Point2D(origenX+alaIzquierda+anchuraPlaca+anchoLateral1,origenY+alaInferior+pliegueInferior+alturaLateral1+alturaLateral2)
	Contour:LineTo(corte20)
	Contour:LineTo(corte21)
	
	--Botas
	local repeticiones=2--math.ceil((alturaPlaca-sumaComienzoFin)/500.0)
	...
	local puntoInicioY=(origenY+alaInferior+pliegueInferior+alturaLateral1+alturaLateral2)
	...
	local corte20 = Point2D(origenX+alaIzquierda-alturaLateral2,origenY+alaInferior+pliegueInferior+alturaLateral2)
	local corte21 = Point2D(origenX+alaIzquierda,origenY+alaInferior+pliegueInferior)
	Contour:LineTo(corte20)
	Contour:LineTo(corte21)
